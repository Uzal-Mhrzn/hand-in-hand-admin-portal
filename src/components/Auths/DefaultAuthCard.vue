...
<template>
  <!-- ====== Forms Section Start -->
  <div
    class="rounded-sm  min-h-screen border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div class="hidden w-full xl:block xl:w-1/2">
        <div class="py-17.5 px-26 text-center">
          ...
          <p class="font-medium 2xl:px-20">
            Log in to Admin App to continue to Admin Portal.
          </p>
