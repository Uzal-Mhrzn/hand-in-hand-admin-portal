...
const handleLogin = async () => {
  ...
  try {
    ...
    if (response.status == 200 || response.status == 201) {
      ...
      authStore.setDesignation(response.data.role);
      loading.value = false;
...
// Watch for changes to clear error messages
watch(email, () => {
...
<template>
  <DefaultAuthCard subtitle="" title="Sign In">
    <form @submit.prevent="handleLogin">
      <InputGroup v-model="email" label="Email" type="email" placeholder="Enter your email" :errorMessage="emailError">
      ...
      <div class="mb-5 mt-6">
        <button type="submit"
          ...
          <span v-else role="status" class="flex justify-center items-center">
